...
results_template = "uni_attack_eta_{eta}.csv"
...
m=len(domain)
pi={zeta: 1/m for zeta in domain} #uniform
...
if __name__ == "__main__":
    ...
    for eta,color_0,color_1 in zip(etas,colors_0,colors_1):
        ...
        # Save as csv:
        print(f"writting results incensus_attack_eta_{eta}.csv")
    ...
    plt.tight_layout()
    plt.savefig(f"uni_attack_J_{mechanism_iterations}.png", dpi=300)
